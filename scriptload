...
_G.HOHO_AD = {
	[1] = {link="https://gcdnb.pbrd.co/images/AVitm37MSdIY.png", exp=tick()+9999, read = "https://contentlocked.net/cl/i/5kd666"},
}
local list = {
	--Pet Catchers
...
spawn(function()
    ...
    -- GroupADS:CreateAds(GetImage("accbloxnet", "https://i.imgur.com/4fhvSM3.png"), "https://contentlocked.net/cl/i/5kd666")
    -- GroupADS:CreateAds(GetImage("hohodiscord", "https://i.imgur.com/e2fdiZD.png"), "https://contentlocked.net/cl/i/5kd666")
end)
